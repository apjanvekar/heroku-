      ...
      if @user.save
        begin
          ...
          if e.message.match('getaddrinfo: No address associated with nodename')
            ...
            flash[:user_error] = e.message + ".<br /><br />This means either the user's e-mail address or BXR's configuration for e-mailing is invalid. Please contact the administrator or check the installation instructions. The user was created nevertheless."
          end
          redirect_to :action => 'list'
        end
      else
